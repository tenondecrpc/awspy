...
- TypeScript 5.x (strict mode), Node.js 20.x runtime + Next.js 16.2.5 (App Router, Server Components), React 19.2.4, Tailwind CSS 4.x (`@theme` tokens), already installed (002-visual-refresh)
- None. Static visual assets under `public/assets/`. No persistence touched (002-visual-refresh)
