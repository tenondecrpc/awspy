...
const DENSITY_CONFIG: Record<Density, { columns: number; rows: number; gap: string; size: number }> = {
    ...
    if (customPatternHref) {
        return (
            <div
                ...
                data-variant="custom"
                className={cn("decorative-pattern-fade pointer-events-none absolute inset-0 bg-cover bg-center", className)}
                style={{
                    ...wrapperStyle,
